...
* Berücksichtigen Sie bei der Erstellung von Layout-Vorlagen die Workflows und Prozesse.
...
Achten Sie darauf, dass Sie keine Optionen ausblenden, die Benutzende für ihre täglichen Workflows benötigen.
...
Erstellen Sie Layouts für Gruppen von Personen, die ähnliche Aufgaben ausführen, Zugriff auf dieselben Teile von Workfront benötigen usw. Dadurch wird nicht nur sichergestellt, dass Benutzende Zugriff auf die Teile von Workfront haben, die sie für ihre Arbeit benötigen, sondern es bedeutet auch, dass System- und Gruppenadministratoren weniger Layoutvorlagen erstellen und verwalten müssen.
...
Optionen im Hauptmenü, wobei die am häufigsten verwendeten Menüelemente an hervorgehobener Stelle stehen (oder das Hauptmenü alphabetisch organisieren)
Menüabschnitte im linken Bedienfeld in einer Reihenfolge, die den Workflow vereinfacht
In der Startseite sichtbare Standard- und benutzerdefinierte Felder, damit Benutzer Zuweisungen abschließen können, ohne Aufgaben/Probleme für erforderliche Informationen analysieren zu müssen

Nachdem Sie die Layout-Vorlage erstellt haben, testen Sie sie mit der Option „Anmelden als“ im Anmeldebereich so, wie die Benutzenden es tun werden. Gehen Sie jeden Schritt des Workflows dieser Person durch, um sicherzustellen, dass sie über die erforderlichen Informationen verfügt, bevor Sie der Vorlage Benutzende zuweisen.
