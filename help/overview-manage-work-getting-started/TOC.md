...
+ Arbeit verwalten - Erste Schritte {#manage-work-getting-started}
   + Projekt erstellen {#create-a-project}
      ...
      + [Konvertieren eines Problems oder einer Anfrage in ein Projekt](create-a-project-from-a-request.md)
   ...
   + Planen eines Projekts {#plan-a-project}
      ...
      + [Grundlegendes zu Aufgabenlaufzeiten](understand-task-durations.md)
      ...
      + [Grundlegendes zu Projekt-Timelines](understand-project-timelines.md)
   ...
   + Verwalten eines Projekts {#manage-a-project}
      + [Erste Schritte beim Projekt-Management](getting-started-manage-a-project.md)
      + [Suchen von Projekten](find-projects.md)
      + [Freigeben eines Projekts](share-a-project.md)
      + [Grundlegendes zum Projekt-Team](understand-the-project-team.md)
      ...
      + [Tracking des Arbeitsfortschritts mit Projektmetriken](track-work-progress-with-project-metrics.md)
      + [Verfolgen des Fortschritts über die Projekt-Timeline](track-work-progress-from-the-project-timeline.md)
